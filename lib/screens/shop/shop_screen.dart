...
class _ShopScreenState extends State<ShopScreen> {
  ...
  void _addToCart(int pricePaise) => setState(() {
    _cartCount++;
    _cartTotal += pricePaise;
  });
        ...
        children: [
          ListView(
            ...
            children: [
              ...
              const Text(
                'Curated sacred essentials, delivered with purity and grace.',
                      ...
                      child: Stack(
                        ...
                        children: [
                          NetworkImageWithPlaceholder(
                            imageUrl:
                                'https://picsum.photos/seed/${seasonalBanners[i].seed}/400/300',
                          ),
                          Container(
                            decoration: const BoxDecoration(
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, i) => SizedBox(
                    width: 130,
                    child: ProductCard(
                      product: essentials[i],
                      onAdd: () => _addToCart(essentials[i].pricePaise),
                    ),
                  ),
                ),
              ),
              ...
              ...kits.map(
                (k) => Padding(
                  ...
                  child: KitCard(kit: k, onAdd: () => _addToCart(k.pricePaise)),
                ),
              ),
              const SizedBox(height: 6),
              ...
              GridView.builder(
                ...
                itemBuilder: (_, i) => ProductCard(
                  product: filtered[i],
                  onAdd: () => _addToCart(filtered[i].pricePaise),
                ),
              ),
              SizedBox(
                height: extraFloatingElementPadding(context, kCartBarHeight),
              ),
            ],
          ),
          Positioned(
            left: 0,
            right: 0,
            bottom: floatingElementBottomOffset(context),
            child: StickyCartBar(
              itemCount: _cartCount,
              totalPaise: _cartTotal,
              onViewCart: () => Navigator.of(
                context,
              ).push(MaterialPageRoute(builder: (_) => const CartScreen())),
            ),
          ),
